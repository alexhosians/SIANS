...
extern double potential_polyhedron_mpir(double r[3], double **vertices, int nfacesB, int* face_ids_other, int trigger[1],
  double datastuff[14], double Rot_A[3][3], double Rot_B_T[3][3]);
extern double grav_field_polyhedron_mpir(double r[3], double **vertices, int nfacesB, int* face_ids_other, double g_field[3], int trigger[1],
